...
\begin{center}
    ...
    \vspace{0.3cm}
    {\large A Soil-Weather Fusion Benchmark (2024--2026) \par}
    \vspace{0.5cm}
...
\begin{enumerate}
    ...
    \item \textbf{Interactive Web Dashboard Deployment:} Build and deploy a full-stack interactive dashboard using Flask (Python backend), Chart.js (frontend visualizations), and modern styling, enabling real-time production inference and data exploration.
\end{enumerate}

% ══════════════════════════════════════════════════════════════════════════════
\section{Related Work and Literature Review (2024--2026)}
...
\subsection{Remote Sensing and Satellite Vegetation Models}
...
\subsection{Macro State-Level Aggregation Models}
...
\subsection{Climate-Only Deep Learning Recurrent Models}
...
\subsection{Single-Crop Specific Models}
...
\subsection{National Soil Health Mapping Initiatives}
\textbf{ICAR and Ministry of Agriculture (2024--2026)} \cite{soilhealthportal} maintained national soil health card datasets tracking NPK levels across Indian farms.
\begin{itemize}
    \item \textbf{Link:} \url{https://soilhealth.dac.gov.in}
...
Figure~\ref{fig:comparison_flow} contrasts the structural limitations of existing research (2024--2026) against our proposed multi-crop soil-weather fusion framework.
...
\end{tikzpicture}
\caption{Existing Research Paradigms (2024--2026) vs. Proposed Multi-Crop Soil-Weather Pipeline.}
...
\begin{table}[htbp]
\caption{Literature Comparison (2024--2026)}
...
\midrule
Sharma et al. \cite{sharma2024remote} & 2024 & 2 Crops & No & Partial & 0.792 \\
Patel and Kumar \cite{patel2025state} & 2025 & 4 Crops & No & Yes & 0.815 \\
Singh et al. \cite{singh2025deep} & 2025 & 1 Crop & No & Yes & 0.843 \\
Ramesh et al. \cite{ramesh2026single} & 2026 & Wheat Only & Partial & Yes & 0.865 \\
ICAR Soil Health \cite{soilhealthportal} & 2024--26 & N/A & Yes & No & N/A \\
IMD Climate Grid \cite{imdclimate} & 2024--26 & N/A & No & Yes & N/A \\
...
\begin{tikzpicture}[
    ...
    \node (s4) [deploy, right=of s3] {\textbf{4. Web Dashboard}\\\footnotesize Flask REST API\\\footnotesize Chart.js Frontend\\\footnotesize Real-time Predictor};
...
We evaluated eight machine learning models. Evaluation metrics included $R^2$, Adjusted $R^2$, Root Mean Squared Error (RMSE), and Mean Absolute Error (MAE). Table~\ref{tab:model_rankings} presents the complete ranking.
...
Indian Council of Agricultural Research (ICAR), ``National Soil Health Card Data Repository,'' Ministry of Agriculture and Farmers Welfare, Government of India, 2024--2026. \\
